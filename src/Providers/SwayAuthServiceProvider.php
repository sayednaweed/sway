...
use Sway\Middleware\DoubleAuthenticateSwayMiddleware;
...
class SwayAuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->app['router']->aliasMiddleware('doubleAuthorized', DoubleAuthenticateSwayMiddleware::class);  // Register new middleware
